...
date: "[`kbroman.org`](http://kbroman.org) <br/> [`github.com/kbroman`](https://github.com/kbroman) <br/> [`@kwbroman`](https://twitter.com/kwbroman) <br/> `kbroman@biostat.wisc.edu`"
output:
...
# Coursework: statistical genomics
...
# Coursework: clinical biostat/informatics
